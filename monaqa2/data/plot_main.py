...
def plot_annealing_classical_queries_and_quantum_queries_vs_n(
    ...
    fig, ax = plt.subplots(figsize=(8.5, 4.8))
    n_vals = np.arange(int(n_plot_min), int(n_plot_max) + 1)
    classical_handles = {}
    classical_labels = {}
    quantum_handles = {}
    quantum_labels = {}
    ...
    for proposal in PROPOSALS_SORTED:
        ...
        for n in n_vals:
            ...
            for beta_t in schedule:
                ...
                classical_total += int(np.ceil(A_q * np.exp(b_q * n)))
        ...
        print(f"{n=} {classical_queries=} {quantum_queries=}")
...
def plot_annealing_classical_queries_and_quantum_runtime_vs_n(
    ...
    for proposal in PROPOSALS_SORTED:
        ...
        print(f"{n=} {classical_runtime=} {quantum_runtime=}")
